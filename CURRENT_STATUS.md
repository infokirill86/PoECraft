...
- SHA256 Git-normalized updater/checker fix: implemented as a tiny repo-integrity tool fix and proposed for Claude audit; not accepted yet.

## Next gate

- Claude audit is required for the proposed SHA256 Git-normalized updater/checker fix.
